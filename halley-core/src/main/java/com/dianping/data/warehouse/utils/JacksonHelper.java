...
public class JacksonHelper {
    ...
    public static <T> T jsonToPojo(String data, T t) {
        try {
            return (T) JacksonHelper.newObjectMapper().readValue(data.getBytes("utf-8"), t.getClass());
        } catch (IOException e) {
            logger.error("Convert json to object error:" + data);
        }
